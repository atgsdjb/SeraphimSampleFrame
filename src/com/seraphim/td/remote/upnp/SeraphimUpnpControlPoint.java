...
public class SeraphimUpnpControlPoint implements NotifyListener,
DeviceChangeListener,
SearchResponseListener,
EventListener
{
	static private final String  TAG="com.seraphim.td.upnp";
	static private SeraphimUpnpControlPoint sulf;
	 ...
	 * 
	 */
	private SeraphimUpnpControlPoint(Context context,Handler handler){
	 ...
	 * @return 
	 */
	static public SeraphimUpnpControlPoint getInstance(Context context,Handler handler){
		if(sulf == null){
			sulf = new SeraphimUpnpControlPoint(context, handler);
		}
		return sulf;
