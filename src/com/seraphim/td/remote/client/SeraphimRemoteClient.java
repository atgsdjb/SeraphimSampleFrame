...
public class SeraphimRemoteClient {
	static private SeraphimRemoteClient sulf;
	...
	static public SeraphimRemoteClient connectServer(String ip,int port){
		if(sulf==null){
			sulf = new SeraphimRemoteClient();
		}else{
			sulf.close();
		}
