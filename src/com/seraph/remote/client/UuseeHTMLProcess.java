...
public class UuseeHTMLProcess {
 static  public  UuseeHTMLProcess sulf;
 private Context mContext;
 private WebView processWebView;
 private UuseeHTMLProcessListener mListener;
 ...
 * @param listener
 */
 private UuseeHTMLProcess(Context context,UuseeHTMLProcessListener listener){
	 mListener  =  listener;
	 mContext = context;
	 processWebView = new WebView(context);
	 initWebView();
 };
 private UuseeHTMLProcess(Context context,WebView webView,UuseeHTMLProcessListener listener){
	 mListener  =  listener;
	 mContext = context;
	 processWebView =webView;
	 initWebView();
 };
 static public UuseeHTMLProcess createProcessHTML(Context context,UuseeHTMLProcessListener listener){
	 if(sulf==null){
		 sulf = new UuseeHTMLProcess(context,listener);
	 }
	 return sulf;
 }
 static public UuseeHTMLProcess createProcessHTML(Context context,WebView webView,UuseeHTMLProcessListener listener){
	 if(sulf==null){
		 sulf = new UuseeHTMLProcess(context,webView,listener);
	 }
	 return sulf;
 }
 /**
