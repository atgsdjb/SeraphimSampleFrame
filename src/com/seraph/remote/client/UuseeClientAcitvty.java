...
public class UuseeClientAcitvty extends Activity {
	...
	private Handler localHandler = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			case UuseeGlobal.MW_SCANNING :
				...
				Toast.makeText(UuseeClientAcitvty.this, "HOST_NAME=="+host+"\tip=="+ip+"\tconnectState=="+connect, Toast.LENGTH_LONG).show();
...
//		requestWindowFeature(Window.FEATURE_NO_TITLE);  
	 ...
	 class JSIntface{
		...
		public  void uusee_cmd_play(String url,String title){
			...
			if(mHTMLProcess == null)
				mHTMLProcess = UuseeHTMLProcess.createProcessHTML(UuseeClientAcitvty.this, new HTMLProceeLisener());
	...
	class HTMLProceeLisener implements UuseeHTMLProcessListener{
		...
		public void errorHTMLProcess(int errorCode) {
			// TODO Auto-generated method stub
			if(errorCode == -2){
				AlertDialog.Builder builder = new AlertDialog.Builder(UuseeClientAcitvty.this);
