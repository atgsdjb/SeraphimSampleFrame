...
public class UuseeClient extends Activity implements View.OnClickListener{
...
//	
	...
	private Handler localHandler = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			switch(msg.what){
			case UuseeGlobal.MW_BEGIN_SCANNED :
				Log.d(TAG,"MW_BEGIN_SCANNED");
				break;
			case UuseeGlobal.MW_SCANNING :
				String host = msg.getData().getString(UuseeGlobal.MSG_KEY_DEVICE);
				String ip = msg.getData().getString(UuseeGlobal.MSG_KEY_IP);
				boolean connect = msg.getData().getBoolean(UuseeGlobal.MSG_KEY_CONNECT,false);
				Log.d(TAG,"HOST_NAME=="+host+"\tip=="+ip+"\tconnectState=="+connect);
				UuseeDeviceInfo info = new UuseeDeviceInfo(ip, host, connect);
				Toast.makeText(UuseeClient.this, "HOST_NAME=="+host+"\tip=="+ip+"\tconnectState=="+connect, Toast.LENGTH_LONG).show();
				...
				break;
			case UuseeGlobal.MW_FINISH_SCANNED :
				Log.d(TAG,"MW_FINISH_SCANNED");
				break;
			case UuseeGlobal.MW_CONNECT_OK :
				connectFlg = true;
				Toast.makeText(getApplicationContext(), "连接成功", Toast.LENGTH_LONG).show();
				break;
			case UuseeGlobal.MW_CONNECT_ERROR :
...
//						String str = null;
						if(UuseeGlobal.exJS == null){
							AssetManager am = UuseeClient.this.getAssets();
							InputStream in =null;
...
//		mWebView.setOnTouchListener(new View.OnTouchListener() {});
		mWebView.addJavascriptInterface(new UuseeJSIntface(this, localHandler), "uusee");
