...
EventListener
{
	 ...
	 * 
	 */
	private UuseeUpnpControlPoint(Context context,Handler handler){
	 ...
	 * @return 
	 */
	static public UuseeUpnpControlPoint getInstance(Context context,Handler handler){
		if(sulf == null){
			sulf = new UuseeUpnpControlPoint(context, handler);
		}
		return sulf;
	...
	public void deviceAdded(Device dev) {
		...
		msg.what =  UuseeGlobal.MW_ADD_DEVICE;
		Bundle data = new Bundle();
		String name = dev.getFriendlyName();
		if(name == null)
			name ="UNKNOWN  DEVICE";
		data.putString(UuseeGlobal.MK_ADD_DEVICE_NAME, name);
		msg.setData(data);
	...
	public void deviceRemoved(Device dev) {
		...
		handler.sendEmptyMessage(UuseeGlobal.MW_DEVICE_LIST_CHANGE);
	...
	public void deviceNotifyReceived(SSDPPacket ssdpPacket) {
		...
		intent.setAction(UuseeGlobal.BROADCASET_REVICE_NOTITY_ACTION);
		intent.putExtra(UuseeGlobal.BORADCASET_NOTITY_DATA_KEY, 
						msg);
