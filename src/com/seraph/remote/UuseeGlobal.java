...
import com.seraph.remote.upnp.UuseeUpnpControlPoint;

public class UuseeGlobal {
...
//	static protected final String webUrl="http://www.youku.com?";
	...
	/*************UPNP GLOBAL DATA**************/
	static public UuseeUpnpControlPoint mCP;
	static public UuseeUpnpControlPoint getCP(){
		return mCP;
	}
	static public void setCP(UuseeUpnpControlPoint cp){
		mCP = cp;
	}
